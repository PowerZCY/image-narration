...
export async function Footer({ locale }: { locale: string }) {
  ...
  const data: FooterData = {
    ...
    refund: tFooter('refund', { defaultValue: 'Refund Policy' }),
      ...
      <footer>
        <div className="w-full flex flex-col items-center justify-center px-4 py-8 space-y-3">
          <div className="flex items-center justify-center space-x-6 text-xs">
            ...
            <Link href={`/${locale}/legal/refund`} className="flex items-center space-x-1 hover:underline">
              <icons.CheckLine className="h-3.5 w-3.5"/>
